import { AppState, CustomChecklist, GameItem, RewardItem, Subject, Task, CalendarEvent, Achievement, ReminderItem, StudySession } from '../types';
import { getTodayString, addDays } from './dateUtils';

const STORAGE_KEY = 'tyler_personal_stuff_os_clean_v1';

export const DEFAULT_SUBJECTS: Subject[] = [
  { id: 'sub_design', name: 'Design Technology', code: 'DES-HL', level: 'HL', color: '#8b5cf6', icon: 'Palette', targetGrade: '7', syllabusTopics: ['Ergonomics', 'CAD & Modeling', 'Sustainable Production', 'User-Centered Design'] },
  { id: 'sub_politics', name: 'Global Politics', code: 'GLO-HL', level: 'HL', color: '#06b6d4', icon: 'Globe', targetGrade: '7', syllabusTopics: ['Power & Sovereignty', 'Human Rights', 'Development', 'Peace & Conflict'] },
  { id: 'sub_music', name: 'Music', code: 'MUS-HL', level: 'HL', color: '#ec4899', icon: 'Music', targetGrade: '7', syllabusTopics: ['Creating', 'Performing', 'Contemporary Music Maker', 'Musical Analysis'] },
  { id: 'sub_german', name: 'German B', code: 'GER-SL', level: 'SL', color: '#f59e0b', icon: 'Languages', targetGrade: '6', syllabusTopics: ['Identities', 'Experiences', 'Human Ingenuity', 'Oral Presentation'] },
  { id: 'sub_english', name: 'English A', code: 'ENG-SL', level: 'SL', color: '#3b82f6', icon: 'BookOpen', targetGrade: '7', syllabusTopics: ['Readers, Writers & Texts', 'Paper 1 Analysis', 'Paper 2 Comparative', 'Individual Oral'] },
  { id: 'sub_math', name: 'Mathematics AI', code: 'MAI-SL', level: 'SL', color: '#6366f1', icon: 'Calculator', targetGrade: '7', syllabusTopics: ['Functions & Modeling', 'Statistics & Probability', 'Calculus', 'Math Exploration IA'] },
];
  ...
  const initialStudySessions: StudySession[] = [
    {
      ...
      subjectId: 'sub_german',
      durationMinutes: 45,
      notes: 'German B oral rehearsal & vocab flashcards (offline study)',
      xpEarned: 20,
      method: 'manual',
    ...
    },
    {
      ...
      subjectId: 'sub_politics',
      durationMinutes: 60,
      notes: 'Global Politics HL case study research & treaties',
      xpEarned: 25,
      method: 'timer',
    ...
    },
    {
      ...
      date: addDays(today, -1),
      subjectId: 'sub_design',
      durationMinutes: 40,
      notes: 'Design Technology CAD sketches & ergonomics layout without timer',
      xpEarned: 15,
      method: 'manual',
      loggedWithoutTimer: true,
    },
    {
      ...
      subjectId: 'sub_math',
      durationMinutes: 50,
      notes: 'Math AI calculus integration & optimization practice',
      xpEarned: 20,
      method: 'timer',
      loggedWithoutTimer: false,
    },
    {
      ...
      subjectId: 'sub_music',
      durationMinutes: 70,
      notes: 'Music HL score analysis and contemporary music maker track without timer',
      xpEarned: 30,
      method: 'manual',
      loggedWithoutTimer: true,
    },
    {
      ...
      subjectId: 'sub_english',
      durationMinutes: 60,
      notes: 'English A comparative essay thesis & textual evidence',
      xpEarned: 25,
      method: 'timer',
      loggedWithoutTimer: false,
    },
    {
      id: 'sess_seed_7',
      timestamp: Date.now() - 1000 * 60 * 60 * 170,
      date: addDays(today, -7),
      subjectId: 'sub_politics',
      durationMinutes: 80,
      notes: 'Global Politics human rights treaties & sovereignty debate prep',
      xpEarned: 35,
      method: 'timer',
      loggedWithoutTimer: false,
    },
    {
      id: 'sess_seed_8',
      timestamp: Date.now() - 1000 * 60 * 60 * 220,
      date: addDays(today, -9),
      subjectId: 'sub_design',
      durationMinutes: 50,
      notes: 'Design HL user testing evaluation and physical prototype testing',
      xpEarned: 20,
      method: 'manual',
      loggedWithoutTimer: true,
    },
    {
      id: 'sess_seed_9',
      timestamp: Date.now() - 1000 * 60 * 60 * 290,
      date: addDays(today, -12),
      subjectId: 'sub_math',
      durationMinutes: 85,
      notes: 'Math AI statistics bivariate regression exercises',
      xpEarned: 35,
      method: 'timer',
      loggedWithoutTimer: false,
    },
    {
      ...
      subjectId: 'sub_german',
      durationMinutes: 45,
      notes: 'German B past paper listening & reading comprehension without timer',
      xpEarned: 20,
      method: 'manual',
      loggedWithoutTimer: true,
    },
    {
      id: 'sess_seed_11',
      timestamp: Date.now() - 1000 * 60 * 60 * 430,
      date: addDays(today, -18),
      subjectId: 'sub_music',
      durationMinutes: 60,
      notes: 'Music HL composition harmony draft and audio stems',
      xpEarned: 25,
      method: 'timer',
      loggedWithoutTimer: false,
    },
    {
      id: 'sess_seed_12',
      timestamp: Date.now() - 1000 * 60 * 60 * 530,
      date: addDays(today, -22),
      subjectId: 'sub_english',
      durationMinutes: 75,
      notes: 'English A guided textual analysis (Paper 1 practice offline)',
      xpEarned: 30,
      method: 'manual',
      loggedWithoutTimer: true,
    },
    {
      id: 'sess_seed_13',
      timestamp: Date.now() - 1000 * 60 * 60 * 620,
      date: addDays(today, -26),
      subjectId: 'sub_politics',
      durationMinutes: 90,
      notes: 'Global Politics HL mock exam revision block',
      xpEarned: 35,
      method: 'timer',
      loggedWithoutTimer: false,
    },
    {
      id: 'sess_seed_14',
      timestamp: Date.now() - 1000 * 60 * 60 * 690,
      date: addDays(today, -29),
      subjectId: 'sub_math',
      durationMinutes: 60,
      notes: 'Math AI modeling workbook revision',
      xpEarned: 25,
      method: 'timer',
      loggedWithoutTimer: false,
    },
...
export function loadAppState(): AppState {
  ...
  try {
    ...
    return {
      ...
      subjects: (parsed.subjects && parsed.subjects.length > 0 && !parsed.subjects.some((s) => s.id === 'sub_biology'))
        ? parsed.subjects
        : defaultState.subjects,
      studySessions: (parsed.studySessions && parsed.studySessions.length > 0)
        ? parsed.studySessions
        : defaultState.studySessions,
